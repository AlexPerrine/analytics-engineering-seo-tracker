...
from scripts.ingest_ga4_page import ingest_g4a_page_data
from scripts.ga4_page_checks import check_ga4_has_data, check_ga4_schema
...
def ingest_ga4_pageviews_dag():
    ...
    check_data_task = PythonOperator(
        ...
        python_callable=check_ga4_has_data,
        provide_context=True,
    )

    check_schema_task = PythonOperator(
        task_id="check_ga4_schema",
        python_callable=check_ga4_schema,
        provide_context=True,
    )
